...
public class ParallelDisplay extends JComponent implements ChangeListener {
    ...
    static {
        UIManager.put("VisualAssistantFDM.gui.ParallelDisplayUI", "VisualAssistantFDM.gui.BasicParallelDisplayUI");
    }
    ...
    public void setModel(VisualAssistantFDM.file.XMLFile model){
        if (this.model != null) {
    ...
    public String getUIClassID(){
        ...
        return "VisualAssistantFDM.gui.ParallelDisplayUI";
    }
